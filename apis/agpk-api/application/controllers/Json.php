...
class Json extends CI_Controller {
    ...
    public function keyboardViewData(){
        ...
        if($apiValidated){
            ...
            $totalRec = $this->JsonModel->viewKeyboardData(KEYBOARD_DATA_TABLE, $whereArray, $conditions);
            ...
            $keyboard = $this->JsonModel->viewKeyboardData(KEYBOARD_DATA_TABLE, $whereArray, $conditions);
