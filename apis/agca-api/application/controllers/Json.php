            ...
            if($chargingCategories != null){
                foreach($chargingCategories as $chargingCategoryRow){
                    ...
                    foreach($charging as $chargingRow){
                        ...
                        $chargingData['charging_music'] = $chargingRow->charging_music;
                        $chargingData['charging_bundle'] = $chargingRow->charging_bundle;
                        $chargingData['charging_view'] = $chargingRow->charging_view;
                        $chargingData['charging_download'] = $chargingRow->charging_download;
                        $chargingData['created_date'] = $chargingRow->created_date;
                        $chargingData['is_animation'] = $chargingRow->is_animation;
                        $chargingData['is_music'] = $chargingRow->is_music;
                        $chargingData['charging_premium'] = $chargingRow->charging_premium;
                        $chargingData['charging_status'] = $chargingRow->charging_status;
        ...
        if($apiValidated){
            ...
            if($charging != null){
                foreach($charging as $Row){
                    ...
                    $chargingData['charging_music'] = $Row['charging_music'];
                    $chargingData['charging_bundle'] = $Row['charging_bundle'];
                    $chargingData['charging_view'] = $Row['charging_view'];
                    $chargingData['charging_download'] = $Row['charging_download'];
                    $chargingData['created_date'] = $Row['created_date'];
                    $chargingData['is_animation'] = $Row['is_animation'];
                    $chargingData['is_music'] = $Row['is_music'];
                    $chargingData['charging_premium'] = $Row['charging_premium'];
                    $chargingData['charging_status'] = $Row['charging_status'];
